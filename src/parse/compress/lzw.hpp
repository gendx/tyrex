...
#ifndef TYREX_PARSE_LZW_HPP
#define TYREX_PARSE_LZW_HPP
...
class Lzw : public Compress
{
public:
    Lzw(bool earlyChange);
...
inline unsigned int Lzw::end() const
    {return mEnd;}

}
}

#endif // TYREX_PARSE_LZW_HPP
